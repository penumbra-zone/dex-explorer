          ...
          <div className='flex justify-between'>
            <div className='flex gap-2'>
              <Button actionType='default' density='compact'>
                <Icon IconComponent={ArrowLeft} size='md' />
              </Button>
              <div className='font-default text-text2xl font-medium leading-text4xl text-transparent bg-clip-text [background-image:linear-gradient(90deg,rgb(244,156,67),rgb(83,174,168))]'>
                Epoch #{epoch}
              </div>
            </div>
            <div className='flex gap-2'>

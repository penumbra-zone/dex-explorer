    ...
    const fetchTokens = async () => {
      ...
      try {
        ...
        if ('lpevent_attributes' in lp_event) {
          asset1 = base64ToUint8Array(lp_event.lpevent_attributes.tradingPair!.asset1.inner);
          asset2 = base64ToUint8Array(lp_event.lpevent_attributes.tradingPair!.asset2.inner);
        } else {
